...
@calc_route_blueprint.route("/calculator/2", methods=["POST"])
def calculator_2():
    try:
...
@calc_route_blueprint.route("/calculator/3", methods=["POST"])
def calculator_3():
    try:
...
@calc_route_blueprint.route("/calculator/4", methods=["POST"])
def calculator_4():
    try:
